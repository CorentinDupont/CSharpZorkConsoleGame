-- Code Generated By dbdiagrams.io
-- link: https://dbdiagram.io/d/60268fd180d742080a3a4df3
-- One error persist in the generation of the code. Replace all boolean fields by bit fields.


-- WARNING: this part drop all the tables ignoring constraints to regenerate the database models.
...
ALTER TABLE [Cells] ADD FOREIGN KEY ([PlayerId]) REFERENCES [Players] ([Id])
GO
